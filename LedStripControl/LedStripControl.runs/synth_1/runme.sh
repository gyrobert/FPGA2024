...
HD_PWD='E:/Diak/GyongyosiRobert/UKDA/LedStripControl/LedStripControl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pulse_fsm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pulse_fsm.tcl
